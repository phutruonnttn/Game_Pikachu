...
var AboutLayer = cc.Layer.extend({
    ...
    init:function () {
        ...
        var about = new cc.LabelTTF("Minigame: Pikachu \nProgrammer: Nguyen Phu Truong", "Arial", 21,
            cc.size(MW.WIDTH * 0.85, 0), cc.TEXT_ALIGNMENT_LEFT );
        about.attr({
            x: winSize.width / 2,
            y: MW.HEIGHT / 2 + 210,
            anchorX: 0.5,
        ...
        about.setColor(cc.color(MW.WHITE_COLOR));
        this.addChild(about);

        var label = new cc.LabelTTF("Go back", "Arial", 21);
        label.setColor(cc.color(MW.WHITE_COLOR));
